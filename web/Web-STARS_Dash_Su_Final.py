...
def update_map(type_data, year_hovered, year_selected_slider, n, states_selected_scatter, checkedValues):
    ...
    if ((states_selected_scatter is not None)):
        selectedpoints = [i['pointIndex'] for i in states_selected_scatter['points']]
    ...
    scl  = [[0.0, '#7fcdbb'],[0.2, '#41b6c4'],[0.4, '#1d91c0'],[0.6, '#225ea8'],[0.8, '#253494'],[1.0, '#081d58']]
    ...
    if (len(selectedpoints) != 0): Choropleth_Data[0]['selectedpoints'] = selectedpoints
